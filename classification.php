    ...
    <div class="container">
        <?php if ($_SESSION['userDb']['userDbSet']): // Überprüfen ob Benutzer Db ausgewählt wurde ?>
            <div class="row">
                <div class="col-12">
                    <div class="card mt-3">
                        <h5 class="card-header" id="addClassification">Klassifikation erfassen</h5>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mt-3">
                        <h5 class="card-header" id="savedClassification">Erfasste Klassifikationen</h5>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <?php
                                    ...
                                    if (mysqli_num_rows($result) >= 1): ?>
                                        <table id="dTableClassification" class="table table-striped">
                                            <thead>
                                                <tr>
                                                    <th scope="col">#</th>
